 ...
 * @author igorc
 */
public class MenuLendo implements ActionListener, MouseListener, ListSelectionListener {
    
    private String[] padrao = {"Você não está lendo a nada agora. Adicione mais livros a sua lista!"};
    ...
    public MenuLendo(String nomeUsuario) {
        ...
        // frame
        frame.setTitle("LiReli - Menu Lendo");
    ...
    public void valueChanged(ListSelectionEvent lse) {
        ...
        if (index != -1) {
            String s = listaLendo.getPorIndice(index);
            String divisor = "   -   ";
